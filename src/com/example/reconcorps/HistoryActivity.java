...
public class HistoryActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //報告回数
        adapter.add(new Employee("【報告回数】", pref.getString(PREF_COUNT, "0")));
        ...
        adapter.add(new Employee("【5m級巨人　討伐数】", pref.getString(PREF_TITAN_5, "0")));
        adapter.add(new Employee("【7m級巨人　討伐数】", pref.getString(PREF_TITAN_7, "0")));
        adapter.add(new Employee("【9m級巨人　討伐数】", pref.getString(PREF_TITAN_9, "0")));
        adapter.add(new Employee("【11m級巨人　討伐数】", pref.getString(PREF_TITAN_11, "0")));
        adapter.add(new Employee("【13m級巨人　討伐数】", pref.getString(PREF_TITAN_13, "0")));
        adapter.add(new Employee("【15m級巨人　討伐数】", pref.getString(PREF_TITAN_15, "0")));
        adapter.add(new Employee("【3m級奇行種　討伐数】", pref.getString(PREF_KIKO_3, "0")));
        adapter.add(new Employee("【5m級奇行種　討伐数】", pref.getString(PREF_KIKO_5, "0")));
        adapter.add(new Employee("【7m級奇行種　討伐数】", pref.getString(PREF_KIKO_7, "0")));
        adapter.add(new Employee("【9m級奇行種　討伐数】", pref.getString(PREF_KIKO_9, "0")));
        adapter.add(new Employee("【11m級奇行種　討伐数】", pref.getString(PREF_KIKO_11, "0")));
        adapter.add(new Employee("【13m級奇行種　討伐数】", pref.getString(PREF_KIKO_13, "0")));
        adapter.add(new Employee("【15m級奇行種　討伐数】", pref.getString(PREF_KIKO_15, "0")));
